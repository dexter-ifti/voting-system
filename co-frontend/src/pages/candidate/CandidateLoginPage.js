...
export const CandidateLoginPage = () => {
    ...
    return (_jsxs("div", { className: "max-w-md mx-auto py-16 px-6", children: [_jsx("h1", { className: "text-2xl font-semibold mb-6", children: "Candidate Login (Wallet)" }), _jsx("button", { onClick: login, disabled: loading, className: "w-full bg-primary/80 hover:bg-primary py-2 rounded font-medium text-sm disabled:opacity-50", children: loading ? 'Connecting...' : 'Connect Wallet & Sign' }), _jsxs("p", { className: "text-xs text-slate-400 mt-4", children: ["Need an account? ", _jsx(Link, { to: "/candidate/register", className: "text-primary", children: "Register" })] }), walletAddress && _jsxs("p", { className: "text-xs text-slate-500 mt-4", children: ["Detected: ", walletAddress] })] }));
};
