...
export const VoterLoginPage = () => {
  ...
  return (
    <div className="max-w-md mx-auto py-16 px-6">
      <h1 className="text-2xl font-semibold mb-6">Voter Login (Wallet)</h1>
      ...
      <p className="text-xs text-slate-400 mt-4">Need an account? <Link to="/voter/register" className="text-primary">Register</Link></p>
